    ...
    <div class="container-fluid px-4">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <form clas="form-horizontal" method="post" action="<?php echo base_url('report/headerlap') ?>" target="_blank">
                            <div class="mb-3">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <form clas="form-horizontal" method="post" action="<?php echo base_url('report/kustomerfull') ?>" target="_blank">
                            <div class="mb-3">
                                <label for="exampleInputEmail" class="form-label">Eksternal file Controller: Menyertakan report hanya pada file berbeda dan diletakkan di folder view</label>
                            </div>
                            <button type="submit" class="btn btn-warning">Cetak Laporan</button>
                        </form>
                    </div>
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <form clas="form-horizontal" method="post" action="<?php echo base_url('report/kustomerkustom') ?>" target="_blank">
                            <div class="mb-3">
